...
int[] BACKGROUND = new int[]{0xFF03092B, 0xFFFFFFFF, 0xFF333333, 0xFF000000}; 
int[] SNAKE = new int[]{0xFF69FF5E, 0xFF000000, 0xFF00BFFF, 0xFFFFFFFF}; 
int[] APPLE = new int[]{0xFFEB4034, 0xFF380000, 0xFF8CFF00, 0xFFFFFFFF}; 
int[] SCORE = new int[]{0xFFAFFF40, 0xFF380000, 0xFF00BFFF, 0xFFFFFFFF}; 
int[] SETTINGTRUE = new int[]{ 0xFF5AFF00,0xFFD1FFB8,0xFF69FF5E, 0xFF69FF5E}; 
int[] SETTINGFALSE = new int[]{0xFFFF0000,0xFFFF9E9E,0xFFFF0550, 0xFFFF0550}; 
int[] HEAD = new  int[]{0xFF69FF5E, 0xFF000000, 0xFF00BFFF, 0xFFFFFFFF}; 
String[] NAME = new String[]{"Default", "Black and White", "High Contrast", "Gradient"}; 
int[] SETTINGS = new int[]{ 0xFF03092B, 0xFFFFFFFF, 0xFF333333, 0xFF000000}; 
